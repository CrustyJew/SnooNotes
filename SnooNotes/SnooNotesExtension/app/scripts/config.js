...
export const userManagerConfig = {
  ...
  loadUserInfo: true,
  signin_url: 'http://localhost:5000/Auth/connect/authorize?client_id=snoonotes&response_type=token&scope=snoonotes&redirect_uri=http://localhost:5001/ExtensionRedirect'
};
